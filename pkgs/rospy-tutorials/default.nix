...
{ lib, buildRosPackage, fetchurl, catkin, message-generation, message-runtime, roscpp-tutorials, rospy, rostest, tutorial-std-msgs }:
buildRosPackage {
  ...
  propagatedBuildInputs = [ message-runtime rospy tutorial-std-msgs ];
